-- Consolidated migration bundle for staging — every file in supabase/migrations/
-- in order, concatenated for a single paste into the Supabase SQL editor.
-- Every migration here is written idempotently (create ... if not exists,
-- create or replace function, drop ... if exists, etc.) so this is safe to
-- run even if staging already has some of these applied — regenerate this
-- file (same command below) whenever new migrations land on main.
--
-- regenerate: for f in supabase/migrations/*.sql; do printf '\n-- ── %s ──\n' "$f"; cat "$f"; done > scripts/staging-apply-all-migrations.sql


-- ── supabase/migrations/20260624000001_schema.sql ──────────────────────────────────────────────
-- ═══════════════════════════════════════════════════════════════════════════════
...
-- ── supabase/migrations/20260624000002_functions.sql ──────────────────────────────────────────────
-- ═══════════════════════════════════════════════════════════════════════════════
...
-- ── supabase/migrations/20260624000003_views_rls.sql ──────────────────────────────────────────────
-- ═══════════════════════════════════════════════════════════════════════════════
...
-- ── supabase/migrations/20260624000004_indexes.sql ──────────────────────────────────────────────
-- ═══════════════════════════════════════════════════════════════════════════════
...
-- ── supabase/migrations/20260627000001_availability_upsert_fn.sql ──────────────────────────────────────────────
...
-- ── supabase/migrations/20260628000001_repair_auth_profiles.sql ──────────────────────────────────────────────
...
-- ── supabase/migrations/20260711000001_fix_available_slots_ambiguity.sql ──────────────────────────────────────────────
...
-- ── supabase/migrations/20260712000001_fix_handle_new_user_coach.sql ──────────────────────────────────────────────
...
-- ── supabase/migrations/20260712000002_fix_referral_code_search_path.sql ──────────────────────────────────────────────
...
-- ── supabase/migrations/20260713000001_fix_release_escrow.sql ──────────────────────────────────────────────
...
-- ── supabase/migrations/20260714000001_db_cleanup.sql ──────────────────────────────────────────────
...
-- ── supabase/migrations/20260719000001_writable_session_columns.sql ──────────────────────────────────────────────
...
-- ── supabase/migrations/20260908000001_auth_password_passkey.sql ──────────────────────────────────────────────
...
-- ── supabase/migrations/20260909000002_fix_admin_metrics_view.sql ──────────────────────────────────────────────
...
-- ── supabase/migrations/20260910000001_admin_player_directory_avatar.sql ──────────────────────────────────────────────
...
-- ── supabase/migrations/20260910000002_pricing_guardrails.sql ──────────────────────────────────────────────
-- ─────────────────────────────────────────────────────────────────────────────
